...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Mod creator'],
			['blue bf',		    'bf',		    'Best br mod creator',	 'https://youtube.com/channel/UCpgYxjh89FmKgx5utEWaZ9Q'],
			['blue gf',		    'gf',		    '2 creator and girlfriend of blue bf ship classic',	 'https://youtube.com/channel/UCMS2DwumrxS88eX8WwH57fQ'],
		    ['Psych Engine Team'],
